...
Rscript --no-echo "code/01-theory-plots.R"

echo "Reproducing Figures 9-10, E1-E5, and I1-I4 and Table E1"
Rscript --no-echo "code/02-house-application.R"

echo "Reproducing Figures 7-8 and Table H1"
Rscript --no-echo "code/03-court-application.R"

echo "Reproducing Figure 6"
Rscript --no-echo "code/04-immigration-application.R"

echo "Reproducing Table 2"
Rscript --no-echo "code/05-log-likelihood-comparison.R"

echo "Reproducing Figure K1 and Table K1"
Rscript --no-echo "code/06-IFE-application.R"

echo "Reproducing Figure 4"
Rscript --no-echo "code/07-temperature-demonstration.R"

echo "Reproducing Figures 5 and F1-F4 and Tables F1 and F2"
Rscript --no-echo "code/08-second-dimension-concerns.R"

echo "Reproducing Tables 1 and D1"
Rscript --no-echo "code/09-monotonic-simulation.R"
...
Rscript --no-echo "code/11-non-monotonicty.R"
